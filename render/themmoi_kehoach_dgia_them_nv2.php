...
<? $stt=0 ; foreach ($str_id as $key => $value):$stt++;  if(in_array($value, $str_id_nv)==true) continue; ?>
  ...
  <td>
    <div class="d_flex align_c">
      <?php if (search($data_list_nv,'ep_id',$value)[0]['ep_image']!=""): ?>
        ...
        <div class="img mr_10 ">
            <img class="wh26_ra" src="https://chamcong.24hpay.vn/upload/employee/<?=search($data_list_nv,'ep_id',$value)[0]['ep_image'];?>" alt="Ngu?i t?o">
        </div>
         <?php endif ?>
        ...
        <div class="img mr_10 ">
            <img class="wh26_ra" src="https://chamcong.timviec365.vn/images/ep_logo.png" alt="Ngu?i t?o">
        </div>
         <?php endif ?>
  ...
  <td>
      <p id-nv='<?=$value?>' onclick="xoanv_danhgia2(this)" class="color_red c-pointer">Xoa</p>
  </td>
</tr>
<? endforeach; ?> -->
<?
