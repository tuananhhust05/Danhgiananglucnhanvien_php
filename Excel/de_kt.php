...
$query=new db_query("SELECT * FROM de_kiemtra where kt_id = '".$id."'");
$value = mysql_fetch_assoc($query->result);
 
$cauhoi= json_decode($value['mang_cauhoi'], true);
header("Content-type: application/octet-stream; charset=utf-8");
header("Content-Disposition: attachment; filename=excel_ds_de_kt.xls");
                        ...
                        <div class="box_header d_flex space_b align_c position_r">
                            <div class="title_header ">
                                <div class="d_flex">
                                    ...
                                    <p>Quản lý đề kiểm tra năng lực<span> / </span><span> chi tiết </span></p>
                                </div>
                            </div>
                            ...
                            <div class="header_ql_tieuchi">
                                <div class="title_header ">
                                    <div class="d_flex">
                                        ...
                                        <p>Quản lý đề kiểm tra năng lực<span> / </span><span> chi tiết </span>
                                        </p>
                                    </div>
                                </div>
                                <div class="d_flex align_c flex_end mb_20">
                                    <div class="btn_header_ql_tieuchi  btn_header_ql_tieuchi_a d_flex">
                                        ...
                                        <div class="sua_excel d_flex">
                                            ...
                                            <a target="_blank" href="/chinh-sua-de-kiem-tra-<?=$row['id']?>.html" class="btn sua">
                                                <div class="img mr_12">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="d_flex flex_start  width_100">
                                                    <div class="d_flex align_c">
                                                        <div class="img mr_10">
                                                             <img class="wh26_ra" src="https://chamcong.24hpay.vn/upload/employee/<?=search($data_list_nv,'ep_id',$row['nguoitao'])[0]['ep_image'];?>" alt="Người tạo">
                                                        </div>
