...
$query= new db_query("SELECT * FROM danhsachcauhoi where id_congty=".$usc_id." order by id desc ");
                    ...
                    <div class="header back_w border_r10 w_100">
                        <div class="box_header d_flex space_b align_c position_r">
                            <div class="title_header">
                                <div class="d_flex"> <a href='/danh-sach-cau-hoi.html'
                                        class="img_quaylai mr_10">
                                        <img src="../img/icon_so.png" alt="Quay lại">
                                    </a>
                                    <p onclick="window.location.href='/danh-sach-cau-hoi.html'" class="c-pointer">Quản lý câu hỏi<span> / </span><span> Thêm mới</span></p>
                                </div>
                            </div>
                            ...
                            <div class="body_ql_tieuchi body_ql_tieuchi_chitiet mb_20">
                                <div class="title_header">
                                    <div class="d_flex"> <a href='/danh-sach-cau-hoi.html'
                                        ...
                                        <p onclick="window.location.href='/danh-sach-cau-hoi.html'" class="c-pointer">Quản lý câu hỏi<span> / </span><span> Thêm mới</span>
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <div class="container mb_20">
                                                    ...
                                                    <div class=" ">
                                                        ...
                                                        <div class="select_no_muti hidden">
                                                            <select name="" id="" class="js_select_2 loaicauhoi hidden arr_cauhoi">
                                                                <option <?if(isset($info)&&$info['hinhthuc']==1) echo 'selected' ?> value="1">Tự luận</option>
                                                                <option <?if(isset($info)&&$info['hinhthuc']==2) echo 'selected' ?> value="2">Trắc nghiệm</option>
                                                                <option <?if(isset($info)&&$info['hinhthuc']==3) echo 'selected' ?> value="3">Hộp kiểm</option>
                                                            </select>
                                                        </div>
                                                                    
                                                        <div onclick="chonloai_cauhoi(this)" class="btn_loaihoi position_r ">
                                                            <div class="width_100 d_flex space_b align_c">
                                                                <div class="sel_dang_1 <?if(isset($info)&&$info['hinhthuc']!=1) echo 'display_none' ?>" id="sel_dang_1">
                                                               ...
                                                               <div class="sel_dang_2 <?if(isset($info)&&$info['hinhthuc']!=2) echo 'display_none' ?>"
                                                                    id="sel_dang_2">
                                                                    <div class="d_flex align_c">
                                                                        <div class="img mr_10">
                                                                ...
                                                                <div class="sel_dang_3 <?if(isset($info)&&$info['hinhthuc']!=3) echo 'display_none' ?>"
                                                                    id="sel_dang_3">
                                                                    <div class="d_flex align_c">
                                                                        <div class="img mr_10">
                                                    ...
                                                    <div class="select_no_muti ">
                                                        ...
                                                        <select class="js_select_2 loai_ch" name="chon_loaicauhoi" id="">
                                                            ...
                                                            <?php foreach ($row as $key => $value): ?>
                                                                <option <?if(isset($info)&&$info['loai']==$value['id']) echo 'selected' ?> value="<?=$value['id']?>"><?=$value['ten_loai']?></option>
                                                            <?php endforeach ?>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form_container">
                                                <div class="form_group ">
                                                    ...
                                                    <input type="text" class="sodiem_ch" name="sodiem_ch_input" value="<?if(isset($info)) echo $info['sodiem'] ?>" placeholder="Nhập số điểm" id="sodiem_ch_input">
                                                </div>
                                                <div class="form_group po_ra">
                                                    ...
                                                    <input type="text" class="time_thuchien " name="time_thuchien_input" 
                                                        value="<?if(isset($info)) echo $info['thoigian_thuchien'] ?>" placeholder="Nhập thời gian" id="time_thuchien_input"> 
                                            ...
                                            <div class="item">
                                                    ...
                                                    <div style="width: 100%;" class="form_group ">
                                                        <div class="flex space_b">
                                                            ...
                                                            <div style="width: 200px;" class="flex j_end c-pointer add_image">
                                                                ...
                                                                <span class="chuxanh size-14 left-5">Chọn ảnh</span>    
                                                            </div>
                                                        </div>
                                                        <input onchange="preview_image();" type="file" multiple id="gallery-photo-add">
                                                        <div class="text_dat ">
                                                            <textarea cols="80" rows=""  id="cauhoi_editor1" class="h_ch cau_hoi arr_cauhoi arr_cauhoi_dapan text_cauhoi" name="cauhoi_editor1"></textarea>
                                                ...
                                                <div class="form_group <?if(isset($info)&&$info['hinhthuc']!=1) echo 'display_none' ?> dangchung_dapan sel_dang_1_dapan pdbot-20">
                                                    <label for="">Đáp án <span class="color_red">*</span></label>
                                                    <div class="text_dat">
                                                        <textarea id="dapan_editor1" class="arr_cauhoi dap_an arr_cauhoi_dapan text_dapan" name="dapan_editor1" cols="80"></textarea>
                                                ...
                                                <!-- dạng trắc nghiệm-->
                                                <div class="form_group <?if(isset($info)&&$info['hinhthuc']!=2) echo 'display_none' ?> sel_dang_2_dapan dangchung_dapan">
                                                    <label for="">Đáp án<span class="color_red">*</span></label>
                                                            ...
                                                            <div class="container_tuychon container_tuychon1">
                                                                <div
                                                                    ...
                                                                    <div class="al_center tuychon_input d_flex width_70  mr_20">
                                                                        ...
                                                                        <input onkeypress="onenter() " type="text" placeholder="Nhập đáp án, chọn để đánh dấu là đáp án đúng,enter để thêm đáp án " name="" class="ten_tuychon keypress_l">
                                                                    </div>
                                                ...
                                                <!-- dạng mặc hộp điểm-->
                                                <div class="form_group <?if(isset($info)&&$info['hinhthuc']!=3) echo 'display_none' ?> sel_dang_3_dapan dangchung_dapan">
                                                    <label for="">Đáp án<span class="color_red">*</span></label>
...
$('.btn_them_tuychon').click(function(){
    $(this).parents('.dangchung_dapan').find('.m_boder_tracnghiem').append('<div class="tuychon mt_5 tochung"><div class="container_tuychon container_tuychon1"><div class="tuychon_header width_100 d_flex space_b align_c"><div class="al_center tuychon_input d_flex width_70  mr_20"><input type="radio" name="answer_tracnghiem" value="Tùy chọn" class="mr_10 answer_right"><input onkeypress="onenter() " type="text" placeholder="Nhập đáp án, chọn để đánh dấu là đáp án đúng " name="" class="ten_tuychon keypress_l"></div><div class="them_anh width_30 flex space_b a_end"><p onclick="del_dapan_tracnghiem(this)" class="color_red size-14 c-pointer top-20">Xoá</p><div onclick="btn_them_anh_tracnghiem(this)" class="btn_them_anh  item d_flex mr_20"><div class="img mr_5"><img  class="btn_them_anhtuychon" src="../img/hoi_7.png" alt="Tải ảnh"></div><p>Thêm ảnh</p></div><input onchange="previewFile(this);" type="file" class="add_tracnghiemanh"></div></div><div class="img_xt_tong mb_20"><img class="img_xt" src="#" alt=""></div></div></div>');
    $('.keypress_l').select();
})
...
$('.add_cauhoi').click(function(){
    ...
    if (sodiem<=0||sodiem=="") {
        alert('Số điểm lớn hơn 0');
        return;
    }
    var time_thuchien=$('.time_thuchien').val();
    if (time_thuchien<=0||time_thuchien=="") {
        alert('Thời gian thực hiện lớn hơn 0');
        return;
    }
...
// $('.keypress_l').keypress(function(e) {
//     var keycode = (event.keyCode ? event.keyCode : event.which);
//     if (keycode == '13'){
//       $('.btn_them_tuychon').click();
//     }
