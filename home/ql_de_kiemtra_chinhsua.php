...
$query= new db_query("SELECT * FROM danhsachcauhoi where id = '".$id."'");
                        ...
                        <div class="box_header d_flex space_b align_c position_r">
                            <div class="title_header">
                                <div class="d_flex"> <a href='/quan_ly_de_kiem_tra_nang_luc.html'
                                    ...
                                    <p onclick="window.location.href='/danh-sach-cau-hoi.html'" class="c-pointer">Quản lý câu hỏi<span> / </span><span> Chỉnh sửa</span></p>
                                </div>
                            </div>
                            ...
                            <div class="body_ql_tieuchi body_ql_tieuchi_chitiet mb_20">
                                <div class="title_header">
                                    <div class="d_flex"> <a href='/quan_ly_de_kiem_tra_nang_luc.html'
                                        ...
                                        <p onclick="window.location.href='/danh-sach-cau-hoi.html'" class="c-pointer">Quản lý câu hỏi<span> / </span><span> Chỉnh sửa</span>
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <div class="container mb_20">
                                                    ...
                                                    <div class=" ">
                                                        ...
                                                        <div class="select_no_muti hidden">
                                                            <select name="" id="" class="js_select_2 loaicauhoi hidden arr_cauhoi">
                                                                <option <?if($info['hinhthuc']==1) echo'selected' ?>  value="1">Câu trả lời</option>
                                                                <option <?if($info['hinhthuc']==2) echo'selected' ?>  value="2">Trắc nghiệm</option>
                                                                <option <?if($info['hinhthuc']==3) echo'selected' ?>  value="3">Hộp kiểm</option>
                                                            </select>
                                                        </div>
                                                                    
                                                        <div onclick="chonloai_cauhoi(this)" class="btn_loaihoi position_r nen_block">
                                                            <div class="width_100 d_flex space_b align_c">
                                                                <div class="sel_dang_1 <?if($info['hinhthuc']!=1) echo'display_none' ?> " id="sel_dang_1">
                                                               ...
                                                               <div class="sel_dang_2 <?if($info['hinhthuc']!=2) echo'display_none' ?>"
                                                                    id="sel_dang_2">
                                                                    <div class="d_flex align_c">
                                                                        <div class="img mr_10">
                                                                ...
                                                                <div class="sel_dang_3 <?if($info['hinhthuc']!=3) echo'display_none' ?>"
                                                                    id="sel_dang_3">
                                                                    <div class="d_flex align_c">
                                                                        <div class="img mr_10">
                                                    ...
                                                    <div class="select_no_muti ">
                                                        ...
                                                        <select class="js_select_2 loai_ch" name="chon_loaicauhoi" id="">
                                                            ...
                                                            <?php foreach ($row as $key => $value): ?>
                                                                <option <?if($info['loai']==$value['id']) echo'selected' ?> value="<?=$value['id']?>"><?=$value['ten_loai']?></option>
                                                            <?php endforeach ?>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form_container">
                                                <div class="form_group ">
                                                    ...
                                                    <input type="text" class="sodiem_ch" name="sodiem_ch_input" value="<?=$info['sodiem']?>" placeholder="Nhập số điểm" id="sodiem_ch_input">
                                                </div>
                                                <div class="form_group po_ra">
                                                    ...
                                                    <input type="text" class="time_thuchien " name="time_thuchien_input" 
                                                        value="<?=$info['thoigian_thuchien']?>" placeholder="Nhập thời gian" id="time_thuchien_input"> 
                                            ...
                                            <div class="item">
                                                <div class="container_form_3 d_flex space_b ">
                                                    <div style="width: 100%;" class="form_group ">
                                                        ...
                                                        <div class="text_dat ">
                                                            <textarea cols="80" rows="10"  id="cauhoi_editor1" class="h_ch cau_hoi arr_cauhoi arr_cauhoi_dapan text_cauhoi" name="cauhoi_editor1" ><?=$info['cauhoi']?></textarea>
                                                ...
                                                <div class="div_preview_image">
                                                    ...
                                                    <div class='m_boder_img_cauhoi flex bot-15'>
                                                        <div class='wh_img_prv flex'>
                                                            <img class='img_cauhoi' style='width: 100%; object-fit: cover;' src='../ajax/uploads/<?=$img?>'>
                                                        </div>
                                                    </div>
                                                    <?php endforeach ?>
                                                </div>
                                                ...
                                                <div class="form_group sel_dang_1_dapan dangchung_dapan pdbot-20 ">
                                                    ...
                                                    <div class="text_dat">
                                                        <textarea id="dapan_editor1" class="arr_cauhoi dap_an arr_cauhoi_dapan text_dapan" name="dapan_editor1" cols="80" rows="10"><?=$info['dap_an']?></textarea>
                                                ...
                                                ?>    
                                                <!-- dạng trắc nghiệm-->
                                                <div class="form_group dangchung_dapan sel_dang_2_dapan ">
                                                            ...
                                                            <div class="container_tuychon container_tuychon1">
                                                                <div
                                                                    ...
                                                                    <div class="al_center tuychon_input d_flex width_70  mr_20">
                                                                        <input type="radio" name="answer_tracnghiem" value="" <?if($value['answer_right'][0]==1)echo 'checked' ?>
                                                                            class="mr_10 answer_right">
                                                                        <input type="text" placeholder="Nhập đáp án, chọn để đánh dấu là đáp án đúng " name="" class="ten_tuychon" value="<?=$value['answer'][0]?>">
                                                                    </div>
                                                ...
                                                <!-- dạng mặc hộp điểm-->
                                                <div class="form_group <?if($info['hinhthuc']!=3) echo'display_none' ?> sel_dang_3_dapan dangchung_dapan">
                                                    <label for="">Đáp án</label>
                                                        ...
                                                        <div class="tuychon mt_5 tochung_hopkiem">
                                                            <div class="container_tuychon container_tuychon1">
                                                                <div
                                                                    class="tuychon_header width_100 d_flex space_b align_c">
                                                                    <div class="al_center tuychon_input d_flex width_70  mr_20">
                                                                        <input <?if($value['answer_right'][0]==1)echo 'checked' ?> type="checkbox" name=an_hopkiem[] value="" 
                                                                            class="mr_10 answer_hopkiem">
                                                                        <input type="text" placeholder="Nhập đáp án, chọn để đánh dấu là đáp án đúng " name="" class="ten_tuychon_hopkiem" value="<?=$value['answer'][0]?>">
                                                                    </div>
                                                                    <div class="them_anh width_30 flex space_b a_end">
                                                                        <p onclick="del_dapan_tracnghiem(this)" class="color_red size-14 c-pointer top-20">Xoá</p>
                                                                        <div onclick="btn_them_anh_tracnghiem(this)" class="btn_them_anh  item d_flex mr_20">
...
<div class="popup popup_500 popup_thanhcong">
        <div class="container">
            <div class="popup_body">
                ...
                <p class="text_a_c ">Chỉnh sửa câu hỏi <span class="font_wB show_xoa_ten"></span> thành
                    công!</p>
...
{   
 ...
 {
  $('.div_preview_image').append("<div class='m_boder_img_cauhoi flex bot-15'> <div class='wh_img_prv flex'><img class='img_cauhoi' style='width: 100%;object-fit: cover;' src='"+URL.createObjectURL(event.target.files[i])+"'></div></div>");
 }
}
...
$('.add_cauhoi').click(function(){
    ...
    var id_cauhoi=<?=$info['id']?>;
    data_send.append('img_cauhoi', arr_img_cauhoi); 
    data_send.append('id_cauhoi', id_cauhoi); 
    data_send.append('m', m); 
    $.ajax({
      type: "POST",
      url: "/ajax/edit_cauhoi.php",
      data: data_send,
      dataType: "json",
      cache: false,
      contentType: false,
