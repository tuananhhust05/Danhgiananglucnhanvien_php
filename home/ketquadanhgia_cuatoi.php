...
$query2=new db_query("SELECT DISTINCT id_doituong,phieu_id FROM  phieu_danhgia_chitiet  where doituong_loai=0 and is_duyet=1 and trangthai_xoa=1 and id_doituong=".$_SESSION['ep_id']." and  id_congty = ".$usc_id." ".$sql."");
                                ...
                                <div class="bangchung" id="bang_chung">
                                    <table class="bangchinh chuden">
                                        ...
                                        <?
                                                ...
                                                ?>
                                                <?php if ($_SESSION['ep_id']==$value['id_doituong']): ?>
...
function search_nhom_ts() {
    ...
    if (key == "" ) {
        window.location.href = "/ketquadanhgia-cuatoi.html";
    } else {
        window.location.href = "/ketquadanhgia-cuatoi.html?keyword=" + key + "&limit=" + limit;
    }
}
...
$('#chon_ban_ghi').change(function() {
    ...
    if (value == "") {
        ...
        window.location.href = "/ketquadanhgia-cuatoi.html?limit=" + value + lien_ket;
    }
});
</script>
