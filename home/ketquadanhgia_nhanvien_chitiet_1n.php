...
$k_part2 = getValue("id","int","GET",0);
$key_p = getValue("id_p","int","GET",0);
$key_p_part2 = getValue("id_p","int","GET",0);
                ...
                <div class="header back_w border_r10 w_100">
                    ...
                    <div class="main_body">
                        <div class="chitiet_kq_1n">
                            ...
                            <div class="flex">
                                <div class="khoi2">
                                    <a target="_blank" href="/Excel/kq_nv.php?id=<?=$k_part2?>&&phieu=<?=$key_p_part2?>">
                                            ...
                                            <div class="nentrang show_js_anbot scrollx_lotrinhchitiet">
                                                ...
                                                <div class="padding15 khoicon">
                                                    <div class="flex center-height">
                                                        ...
                                                        <div class="flex center-height">
                                                            <?php if (search($data_list_nv,'ep_id',$key)[0]['ep_image']!=""): ?>
                                                                <img src="https://chamcong.24hpay.vn/upload/employee/<?=search($data_list_nv,'ep_id',$key)[0]['ep_image'];?>" class="wh26_ra right-10" alt="người đánh giá">
                                                            <?php endif ?>
                                                            <?php if (search($data_list_nv,'ep_id',$key)[0]['ep_image']==""): ?>
                                                                <img src="https://chamcong.timviec365.vn/images/ep_logo.png" class="wh26_ra right-10" alt="người đánh giá"> 
                                                            <?php endif ?>
                                                            
                                                    <p class="size-14"><?=search($data_list_nv,'ep_id',$key)[0]['ep_name']?>
                                                    </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="padding15 khoicon">
                                                    <div class="flex">
                                                        ...
                                                        <p class="cacketqua"><?=search($data_list_nv,'ep_id',$key)[0]['dep_name']?></p>
                                                    </div>
                                                </div>
                                                <div class="padding15 khoicon">
                                                    <div class="flex">
                                                        <p class="cacmuc">Chức vụ:</p>
                                                        <p class="cacketqua"><? $cv=search($data_list_nv,'ep_id',$key)[0]['position_id'];?><?=$array_cv[$cv]?></p>
                                                    </div>
                                                </div>
                                                <div class="padding15 khoicon">
                                                    <div class="flex">
...
<? foreach ($row as $row_diem) {
    ...
    $tongdiem_kt=$row_diem['tongdiem_kt'];
                                    ...
                                    <div class="khoibang mot-mot po_r">
                                        <div class="thanh_dk">
                ...
                <td colspan="2" class="<? 
                    ...
                    if($loai_pl_de=="") echo"Chưa có xếp loại";
                     ?>      
                        ...
                        <? if ($dem>1&& $de_danhgia_id!=NULL) {
                            ?>
                                    <h4 class="chuxanh size-16 font-bold top-20 bot-20">Kết quả đánh giá</h4>
                                ...
                                <div class="bangchung" id="bang_chung">
                                    ...
                                    <div class="khoibang mot-mot ">
                                        ...
                                        <div style="height: 600px;overflow-y: auto;" class="bangchung " id="">
                                            <table class="bangchinh chuden ">
                                                <tr>
                                                    <th class="w_same_3">
                                                ...
                                                <?php $stt=0; foreach ($de_kiemtra as $key_kt => $value_kt): $stt++;
                                                    $query= new db_query("SELECT * FROM danhsachcauhoi where id = '".$value_kt."'");
                                                    $info = mysql_fetch_assoc($query->result);
                                                ?>
                                                <?$info['cauhoi'] = str_replace('<br />', '', $info['cauhoi'] );?>
                                                    <tr>
                                                        <td class="text-left font-bold">Câu hỏi <?=$stt?>: <?=$info['cauhoi']?></td>
                                         ...
                                         <?php if ($dem>1): ?>
                                             <h4 class="chuxanh size-16 font-bold top-20 bot-20">Kết quả đề kiểm tra</h4>
                                                <div class="khoibang po_r">
                                                    ...
                                                    <div style="height: 600px;overflow-y: auto;" class="bangchung " id="bang_chung2">
                                                        <table class="bangchinh chuden ">
                                                            <tr>
                                                                <th class="w_same_3">
                                                                    <p class="phantucon">Câu hỏi</p>
                                                                ...
                                                                <th class="w_same_4">
                                                                    <div class="flex center-height phantucon">
                                                                        <div class="flex center-height">
                                                                            <img src="https://chamcong.24hpay.vn/upload/employee/<?=search($data_list_nv,'ep_id',$value_kt['id_nguoidanhgia'])[0]['ep_image'];?>" class="wh26_ra right-10" alt="người đánh giá">
